...
@section('content')
    <div class="row">
        <div class="col-md-12">
                <a class="c-btn c-btn--info pull-right" href="{{route('employee.create')}}">Tambah Baru</a> 
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
                <table class="c-table">
                        <thead class="c-table__head">
                            <tr class="c-table__row">
                                ...
                                <th class="c-table__cell c-table__cell--head">ID Pegawai</th>
                        ...
                        <tbody>
                            @foreach($datas as $data)
                                <tr class="c-table__row">
                                    ...
                                    <td class="c-table__cell">{{$data->id_pegawai}}</td>
                                    <td class="c-table__cell">{{$data->nama}}</td>
                                    <td class="c-table__cell">{{$data->alamat}}</td>
                                    <td class="c-table__cell">{{$data->jenis_kelamin}}</td>
