...
@section('content')
    <div class="row">
        <div class="col-md-12">
                <a class="c-btn c-btn--info pull-right" href="{{route('product.create')}}">Tambah Baru</a> 
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
                <table class="c-table">
                        <thead class="c-table__head">
                            <tr class="c-table__row">
                                ...
                                <th class="c-table__cell c-table__cell--head">Category Id</th>
                        ...
                        <tbody>
                            @foreach($datas as $data)
                                <tr class="c-table__row">
                                    ...
                                    <td class="c-table__cell">{{$data->category->name}}</td>
                                    <td class="c-table__cell">{{$data->category_id}}</td>
